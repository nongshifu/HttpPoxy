...
#define DEFAULT_WINDOW_WIDTH 240//菜单宽度
...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    ...
    [scrollView setContentSize:CGSizeMake(0, [UIScreen mainScreen].bounds.size.width-170)];
    ...
    _labelTitle.textColor = UIColorFromHEX(0xF18A29); //主菜单头字体颜色
    _viewText.textColor = UIColorFromHEX(0xe600e9); //主菜2单头字体颜色
    _contentView.layer.borderColor = UIColorFromHEX(0xCCCCCC).CGColor; //边框十六进制代码
}
...
- (SCLAlertViewResponder *)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    switch (style)
    {
        ...
        case SCLAlertViewStyleInfo:
            viewColor = UIColorFromHEX(0x008B8B);
